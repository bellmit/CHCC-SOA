package com.guihe.platform.core.constants;

/**
 * @author liujunqin 全局常量类。
 */
public class GlobalConstant {
    ...
    /**
     * 接口里面的成员变量都默认是public static final的
     */
    public interface Number {
        ...
        int ONEHUNDREDANDTWENTY_INT = 120;
    }
    ...
    public static final class Sys {
         ...
         * 高级管理员
         */
        public static final String SENIOR_ADMINISTRATOR = "seniorAdministrator";
    ...
    public static final Double MAX_DOUBLE_12_2 = 9999999999.99;
